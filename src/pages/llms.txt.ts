...
export async function GET(context: APIContext) {
  ...
  const lines = [
    '# Aryaman Agrawal',
    '',
    '> Writing about memory, agents, and the things in between. Engineer at Falconer in San Francisco. Currently working on cortical memory architectures and the philosophy of artificial recall.',
    '',
    '## Essays',
    '',
