...
export async function GET(context: APIContext) {
  ...
  const lines = [
    ...
    "",
    ...writings.map(
      (e) => `- [${e.data.title}](${site}/writings/${e.id}): ${e.data.summary}`,
    ),
    "",
    "## Poems",
    "",
    ...
    `- [Full text of all writings](${site}/llms-full.txt)`,
